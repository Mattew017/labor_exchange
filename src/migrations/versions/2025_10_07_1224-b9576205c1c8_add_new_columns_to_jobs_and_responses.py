"""add new columns to jobs and responses

Revision ID: b9576205c1c8
Revises: e31beef93767
Create Date: 2025-10-07 12:24:35.522359
...
def upgrade() -> None:
    ...
    op.add_column(
        "jobs",
        sa.Column(
            "title", sa.String(), nullable=False, comment="Название вакансии"
        ),
    )
    op.add_column(
        "jobs",
